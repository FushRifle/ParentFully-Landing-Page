    ...
    return (
        <>
            ...
            <form noValidate onSubmit={onSubmit} className="mt-7 grid gap-5 sm:grid-cols-2">
                ...
                <label className={labelClass}><span>Phone number *</span><input required type="tel" autoComplete="tel" className={inputClass} value={form.phone} onChange={(event) => onChange('phone', event.target.value)} placeholder="+1 000 000 0000" /></label>
                <label className={labelClass}><span> Number of classes (optional)</span><input min="1" step="1" type="number" inputMode="numeric" className={inputClass} value={form.classCount} onChange={(event) => onChange('classCount', event.target.value)} placeholder="e.g. 12" /></label>
                <label className={labelClass}><span>Approximate number of families (optional)</span><input min="1" step="1" type="number" inputMode="numeric" className={inputClass} value={form.familyCount} onChange={(event) => onChange('familyCount', event.target.value)} placeholder="e.g. 300" /></label>
